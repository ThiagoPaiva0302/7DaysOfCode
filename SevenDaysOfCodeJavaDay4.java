...
public class SevenDaysOfCodeJavaDay4 {
	...
	public static <Filmes> void main(String[] args) throws Exception {
...
//		pontuacao.forEach(System.out::println);
		...
		Filme filme = new Filme(titulos, pontuacao, pontuacao, pontuacao);
		
		System.out.println(filme.exibiFilme(filme.getTitulos(), imagem, pontuacao, 0));
	...
	public static List<String> parseTitulo(String[] filmesArray){
		return parseAtributo(filmesArray, 3);
		
	}
	
	public static List<String> parseImagem(String[] filmesArray){
	
		return parseAtributo(filmesArray, 5);
	}

	public static List<String> parsePontuacao(String[] filmesArray){
		
		return parseAtributo(filmesArray, 1);
	}
	
	public static List<String> parseLancamento(String[] filmesArray) {
